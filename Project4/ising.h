...
void ising_mpi(double T_0, double T_N, double dT, int num_spins, int num_mc_cycle,
...
void write_to_file(std::ofstream& outfile, double T, double* expectation_values, int accepted_states,
