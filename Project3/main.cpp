...
int main(){
    //two_body();
    std::string scenario = "Mercury_GR";
    planet* planets;
    int num_planets;
    bool fixed_sun;
    ...
    double t_max = 100.4;        // Upper time in years
    double t_write = 10;     // Write to file every t_write days
    ...
    solar_system.solve(h, t_max, t_write, "verlet_GR");      // Solve nbody-system using specified method
